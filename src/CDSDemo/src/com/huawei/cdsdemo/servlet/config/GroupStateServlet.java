 ...
 */
public class GroupStateServlet extends HttpServlet
{
    private static final long serialVersionUID = 1L;
    
    private static Logger log = LoggerFactory.getLogger(GroupStateServlet.class);
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupStateServlet()
    {
        super();
    }
    ...
    
    {
        try
        {
            ...
            {
                result = usersession.groupState(groupNumber);
            }
