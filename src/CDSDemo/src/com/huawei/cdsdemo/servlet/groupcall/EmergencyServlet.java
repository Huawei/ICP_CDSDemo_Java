...
public class EmergencyServlet extends HttpServlet
{
	...
	private static Logger log = LoggerFactory.getLogger(EmergencyServlet.class);
    /**
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    result = usersession.emergencyAnswer(groupNumber);
                } 
                else if ("DELETE".equalsIgnoreCase(reqMethod))
                {
                    result = usersession.emergencyExit(groupNumber);
                }
            }
